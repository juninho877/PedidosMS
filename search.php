        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
                    ...
                    <a href="search.php" class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors bg-blue-600 text-white text-sm lg:text-base">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <div class="flex-1">
                            <input
                                ...
                                class="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base"
                                required
                            />
                        </div>
                        <div class="flex gap-2 sm:gap-3">
                            ...
                            <button
                                type="submit"
                                id="searchBtn"
                                class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-600 disabled:cursor-not-allowed text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base"
                            >
                    ...
                    <div id="filtersSection" class="border-t border-slate-700 pt-4 sm:pt-6 space-y-4 hidden">
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select
                                    id="contentType"
                                    class="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                                >
            ...
            <div id="viewControls" class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 hidden">
                ...
                <div class="flex items-center space-x-2">
                    <button
                        id="gridView"
                        class="p-2 sm:p-3 rounded-lg transition-colors bg-blue-600 text-white"
                    >
