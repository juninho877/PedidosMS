        ...
        class ClientDashboard {
            ...
            async showRequestDetails(requestId) {
                ...
                if (!modal) {
                    ...
                    modalElement.id = 'requestDetailsModal';
                    modalElement.className = 'fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 hidden';
            ...
            getStatusClass(status) {
                switch (status) {
                    ...
                    case 'denied': return 'bg-red-600 text-red-100';
