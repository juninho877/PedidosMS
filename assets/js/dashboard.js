                        ...
                        <div class="space-y-6">
                            ...
                            ${request.status === 'pending' ? `
                                <div class="flex space-x-4">
                                    <button
                                        onclick="dashboard.updateStatus(${request.id}, 'approved'); document.getElementById('requestModal').classList.add('hidden')"
                                    ...
                                    <button
                                        onclick="dashboard.updateStatus(${request.id}, 'denied'); document.getElementById('requestModal').classList.add('hidden')"
