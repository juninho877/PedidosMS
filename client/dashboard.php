        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
                    <a href="/client/dashboard.php" class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors bg-primary text-white text-sm lg:text-base">
                    ...
                    <a href="/<?php echo htmlspecialchars($client['slug']); ?>" class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors text-slate-300 hover:text-white hover:bg-slate-700 text-sm lg:text-base">
                        ...
                        <span class="hidden lg:inline">Meu Site</span>
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-slate-800/50 border border-slate-700 rounded-lg mb-6">
                <div class="flex flex-wrap border-b border-slate-700">
                    <button class="tab-btn active px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-medium transition-colors" data-tab="overview">
                        <i data-lucide="bar-chart-3" class="h-4 w-4 sm:h-5 sm:w-5 mr-2"></i>
                        <span class="hidden sm:inline">Visão Geral</span>
                        <span class="sm:hidden">Overview</span>
                    </button>
                    <button class="tab-btn px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-medium transition-colors" data-tab="requests">
                        <i data-lucide="film" class="h-4 w-4 sm:h-5 sm:w-5 mr-2"></i>
                        <span class="hidden sm:inline">Solicitações</span>
                        <span class="sm:hidden">Pedidos</span>
                    </button>
                    <button class="tab-btn px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-medium transition-colors" data-tab="settings">
                        <i data-lucide="settings" class="h-4 w-4 sm:h-5 sm:w-5 mr-2"></i>
                        <span class="hidden sm:inline">Configurações</span>
                        <span class="sm:hidden">Config</span>
                    </button>
                    <button class="tab-btn px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-medium transition-colors" data-tab="analytics">
                        <i data-lucide="trending-up" class="h-4 w-4 sm:h-5 sm:w-5 mr-2"></i>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                            <div class="bg-slate-800/50 border border-slate-700 rounded-lg p-4 sm:p-6">
                                <div class="flex items-center space-x-3 mb-4">
                                    ...
                                    <div>
                                        <p class="text-xl sm:text-2xl font-bold text-white" id="totalRequests">-</p>
                                        <p class="text-xs sm:text-sm text-slate-400">Total de Solicitações</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-800/50 border border-slate-700 rounded-lg p-4 sm:p-6">
                                <div class="flex items-center space-x-3 mb-4">
                                    <i data-lucide="clock" class="h-6 w-6 sm:h-8 sm:w-8 text-yellow-400"></i>
                                    <div>
                                        <p class="text-xl sm:text-2xl font-bold text-white" id="pendingRequests">-</p>
                                        <p class="text-xs sm:text-sm text-slate-400">Pendentes</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-800/50 border border-slate-700 rounded-lg p-4 sm:p-6">
                                <div class="flex items-center space-x-3 mb-4">
                                    <i data-lucide="check-circle" class="h-6 w-6 sm:h-8 sm:w-8 text-green-400"></i>
                                    <div>
                                        <p class="text-xl sm:text-2xl font-bold text-white" id="approvedRequests">-</p>
                                        <p class="text-xs sm:text-sm text-slate-400">Aprovadas</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-800/50 border border-slate-700 rounded-lg p-4 sm:p-6">
                                <div class="flex items-center space-x-3 mb-4">
                                    <i data-lucide="x-circle" class="h-6 w-6 sm:h-8 sm:w-8 text-red-400"></i>
                                    <div>
                                        <p class="text-xl sm:text-2xl font-bold text-white" id="deniedRequests">-</p>
                                        <p class="text-xs sm:text-sm text-slate-400">Negadas</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="requests-tab" class="tab-content hidden">
                        ...
                        <div class="bg-slate-800/50 border border-slate-700 rounded-lg p-4 mb-6">
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <input type="text" id="searchFilter" placeholder="Buscar..." class="px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 text-sm">
                            </div>
                        </div>
