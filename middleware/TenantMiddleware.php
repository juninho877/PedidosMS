...
class TenantMiddleware {
    ...
    public function getTenantConfig() {
        ...
        return [
            ...
            'site_name' => self::$currentTenant->site_name ?: self::$currentTenant->name,
            'site_tagline' => self::$currentTenant->site_tagline,
            'site_description' => self::$currentTenant->site_description,
            'contact_email' => self::$currentTenant->contact_email,
            'contact_whatsapp' => self::$currentTenant->contact_whatsapp,
