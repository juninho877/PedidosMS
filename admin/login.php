    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="max-w-md w-full">
            <div class="text-center mb-6 sm:mb-8">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">Acesso Administrativo</h1>
                <p class="text-sm sm:text-base text-slate-400 px-4">Entre com suas credenciais para acessar o painel</p>
            </div>
